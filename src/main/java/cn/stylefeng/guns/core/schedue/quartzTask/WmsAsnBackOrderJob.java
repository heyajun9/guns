...
public class WmsAsnBackOrderJob implements Job {
...
//									System.out.println("danj_no="+wmsAsnInfoBack.getDanj_no());
//									System.out.println("hanghao:"+wmsAsnInfoBack.getHanghao());
