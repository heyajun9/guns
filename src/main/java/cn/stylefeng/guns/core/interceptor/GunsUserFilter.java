...
import cn.stylefeng.guns.core.util.JsonReader;
        ...
        if (httpServletRequest.getHeader("x-requested-with") != null
            ...
            if (referer == null) {
                if("application/json".equalsIgnoreCase(httpServletRequest.getContentType())){
                    httpServletRequest.getRequestDispatcher(httpServletRequest.getRequestURI().toString()).forward(request,response);
                }else {
