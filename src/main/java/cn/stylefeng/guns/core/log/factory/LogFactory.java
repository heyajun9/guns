...
public class LogFactory {
     ...
     * 创建接口日志
     */
    public static WmsInterfaceLog createInterfaceLog(LogType logType, Long userId, String bussinessName, String clazzName, String methodName, String msg, LogSucceed succeed) {
        WmsInterfaceLog interfaceLog = new WmsInterfaceLog();
        interfaceLog.setLogType(logType.getMessage());
        interfaceLog.setLogName(bussinessName);
        interfaceLog.setUserId(userId);
        interfaceLog.setClassName(clazzName);
        interfaceLog.setMethod(methodName);
        interfaceLog.setCreateTime(new Date());
        interfaceLog.setSucceed(succeed.getMessage());
        interfaceLog.setMessage(msg);
        return interfaceLog;
    }
